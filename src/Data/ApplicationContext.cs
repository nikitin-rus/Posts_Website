...
namespace Posts_Website.Data
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Post[] posts = [
                new(Guid.NewGuid(), users[0].Id, "Расшифровка кода Энигмы", """
                ...
                new(Guid.NewGuid(), users[1].Id, "Переход через Ла-Манш на воздушном шаре", """
                ...
                new(Guid.NewGuid(), users[2].Id, "Первый в мире программируемый компьютер: Z3", """
